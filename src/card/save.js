...
export default function save( { attributes } ) {
	...
	return (
		<div className={ classes }>
			<div className="wp-block-card__inner-wrap">
				<div className="wp-block-card__inner-container">
					<div data-url={ url } style={ style } className="wp-block-card__background-image">
						{ VIDEO_BACKGROUND_TYPE === backgroundType && (
							<video
								className="wp-block-card__video-background"
								autoPlay
								muted
								loop
								src={ url }
					...
					<div className="card-content">
						<div className="wp-block-card__inner-content">
							{ heading && (
								<RichText.Content
									tagName="h1"
									className="card-heading typewriter"
									value={ heading }
								/>
							) }
							{ text && (
