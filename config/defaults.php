...
heading-h-3-h-4-color: #333;
heading-h-3-h-4-color-hover: #444;
heading-h-5-h-6-color: #333;
heading-h-5-h-6-margin-bottom: 30px;
nav-color: #8e8e8e;
...
heading-font-h-4-weight: 400;
heading-font-h-4-letter-spacing: 2px;
...
heading-font-size-h-1: 62px;
heading-font-size-h-2: 60px;
heading-font-size-h-3: 30px;
heading-font-size-h-4: 20px;
heading-font-size-h-4-tiny: 13px;
heading-font-size-h-4-tiny-letter-spacing: 2px;
heading-font-size-h-5: 18px;
heading-font-size-h-6: 20px;
heading-font-style-h-6: italic;

heading-font-size-h-1-desktop: 64px;
heading-font-size-h-1-ipad: 48px;
heading-font-size-h-1-tablet: 36px;

heading-font-size-h-2-ipad: 40px;
heading-font-size-h-3-ipad: 22px;
heading-font-size-h-4-ipad: 18px;
heading-font-size-h-5-ipad: 16px;
heading-font-size-h-6-ipad: 20px;

heading-font-hero-h-4-letter-spacing: 10px;
heading-font-hero-h-4-font-size: 18px;
heading-font-hero-h-4-font-weight: 400;
heading-font-hero-h-4-text-transform: uppercase;
...
return array(
	...
	'banner-mba-image' => '',
	'banner-mba-text' => '',
	'banner-mba-short-text' => '',
	'banner-mba-url' => '',
	'banner-mba-button' => 'Learn More',
	'banner-home-image' => '',
	'banner-home-text' => '',
	'banner-home-short-text' => '',
	'banner-home-url' => '',
	'banner-home-button' => 'Learn More',
	'banner-default-image' => '',
	'banner-default-text' => '',
	'banner-default-short-text' => '',
	'banner-default-url' => '',
	'banner-default-button' => 'Learn More',
);
