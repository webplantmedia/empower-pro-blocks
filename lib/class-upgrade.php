 ...
 * Leadership Pro
 *
 * WARNING: This file is part of the core Leadership Pro Framework. DO NOT edit this file under any circumstances.
 *
...
if ( ! class_exists( 'Leadership_Pro_Upgrade' ) ) :
	/**
	 * The Leadership_Pro WooCommerce Integration class.
	 */
	class Leadership_Pro_Upgrade {
		/**
		 * Template name.
		 *
		 * @var string
		 */
		private $template_name = 'leadership-pro';
		 ...
		 *
		 * Applies `leadership_pro_update_remote_post_options` filter.
		 *
		 ...
		 *               theme does not support `leadership-pro-auto-updates`.
		 */
		public function update_check() {
			global $leadership_pro;
			...
			if ( ! $theme_update ) {
				...
				$options = apply_filters(
					'leadership_pro_update_remote_post_options',
					array(
		...
		/**
		 * Integrate the Leadership Pro update check into the WordPress update checks.
		 *
		 * This function filters the value that is returned when WordPress tries to pull theme update transient data.
		 *
		 * It uses `leadership_pro_update_check()` to check to see if we need to do an update, and if so, adds the proper array to the
		...
		/**
		 * Delete Leadership Pro update transient after updates or when viewing the themes page.
		 *
...
return new Leadership_Pro_Upgrade();
