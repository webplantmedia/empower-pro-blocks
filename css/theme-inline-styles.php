...
function empower_pro_blocks_get_css( $appearance ) {
	...
	$css .= "
		...
		html button,
		html button.primary,
		html #genesis-content div.wpforms-container-full .wpforms-form button[type='submit'].primary,
		...
		html a.button:focus,
		html a.button:hover,
		html #genesis-content div.wpforms-container-full .wpforms-form button[type='submit'].primary:focus,
		html #genesis-content div.wpforms-container-full .wpforms-form button[type='submit'].primary:hover,
		html button:focus,
		html button:hover,
		...
		html #genesis-content div.wpforms-container-full .wpforms-form input:focus,
		html #genesis-content div.wpforms-container-full .wpforms-form textarea:focus,
		html #genesis-content div.wpforms-container-full .wpforms-form select:focus,
		...
		html #genesis-content div.wpforms-container-full .wpforms-form input[type='submit'],
		html #genesis-content div.wpforms-container-full .wpforms-form button[type='submit'],
		html #genesis-content div.wpforms-container-full .wpforms-form .wpforms-page-button,
		...
		html #genesis-content div.wpforms-container-full .wpforms-form input[type='submit']:focus,
		html #genesis-content div.wpforms-container-full .wpforms-form input[type='submit']:hover,
		html #genesis-content div.wpforms-container-full .wpforms-form button[type='submit']:focus,
		html #genesis-content div.wpforms-container-full .wpforms-form button[type='submit']:hover,
		html #genesis-content div.wpforms-container-full .wpforms-form .wpforms-page-button:focus,
		html #genesis-content div.wpforms-container-full .wpforms-form .wpforms-page-button:hover,
