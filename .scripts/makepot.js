...
wpi18n.makepot(
	{
		...
		potHeaders: {
			'poedit': true,
			'x-poedit-basepath': '..',
			'report-msgid-bugs-to': 'Web Plant Media <contact@webplantmedia.com>',
			'last-translator': 'Web Plant Media <contact@webplantmedia.com>',
			'language-team': 'Web Plant Media <contact@webplantmedia.com>'
		}
	}
).then(
